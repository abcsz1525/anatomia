 ...
 * Монтируется только на мобильной раскладке (вызывающий код проверяет
 * `useIsMobile()`), а `md:hidden` держит её скрытой, если ширина вдруг
 * вырастет раньше, чем медиазапрос перерисует дерево.
 */
